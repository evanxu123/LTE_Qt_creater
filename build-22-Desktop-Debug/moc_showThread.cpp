...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_showThread_t, stringdata) + ofs \
...
const QMetaObject showThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_showThread.data,
      qt_meta_data_showThread,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_showThread.stringdata))
        return static_cast<void*>(const_cast< showThread*>(this));
